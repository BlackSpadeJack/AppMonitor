 ...
 * {@link #afterDefaultHandling(HeapDump, AnalysisResult, String)} to add custom behavior, e.g.
 * uploading the heap dump.
 */
public class DisplayLeakService extends AbstractAnalysisResultService {
    ...
    protected final void onHeapAnalyzed(HeapDump heapDump, AnalysisResult result) {
        ...
        if (renamedFile == null) {
            // No file available.
            Log.e("LeakCanary", "Leak result dropped because we already store " + maxStoredLeaks
                    + " leak traces.");
            afterDefaultHandling(heapDump, result, leakInfo);
            return;
        }
     ...
     * the heap dump. Don't forget to check {@link AnalysisResult#leakFound} and
     * {@link AnalysisResult#excludedLeak} first.
     */
