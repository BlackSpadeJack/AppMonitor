...
public final class LeakCanary {
    ...
    /**
     * Creates a {@link RefWatcher} that reports results to the provided service, and starts
    ...
    public static String leakInfo(Context context, HeapDump heapDump, AnalysisResult result) {
        ...
        info +=
                "* Reference Key: " + heapDump.referenceKey + "\n" + "* Device: "
                        ...
                        + heapDump.gcDurationMs + "ms, heap dump=" + heapDump.heapDumpDurationMs
                        + "ms, analysis=" + result.analysisDurationMs + "ms" + "\n";
