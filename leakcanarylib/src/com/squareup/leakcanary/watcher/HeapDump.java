...
public final class HeapDump implements Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = -615819853278417305L;
    ...
    /**
     * Key associated to the {@link KeyedWeakReference} used to detect the memory leak. When
     * analyzing a heap dump, search for all {@link KeyedWeakReference} instances, then open the one
     * that has its "key" field set to this value. Its "referent" field contains the leaking object.
     * Computing the shortest path to GC roots on that leaking object should enable you to figure
