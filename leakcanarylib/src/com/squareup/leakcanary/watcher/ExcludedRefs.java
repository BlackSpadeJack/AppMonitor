 ...
 * 
 * This class lets you ignore known memory leaks that you known about. If the shortest path matches
 * {@link ExcludedRefs}, than the heap analyzer should look for a longer path with nothing matching
 * in {@link ExcludedRefs}.
 */
public final class ExcludedRefs implements Serializable {
    ...
    private ExcludedRefs(Map<String, Set<String>> excludeFieldMap,
        ...
        // Copy + unmodifiable.
        this.excludeFieldMap =
                unmodifiableMap(new LinkedHashMap<String, Set<String>>(excludeFieldMap));
        this.excludeStaticFieldMap =
                unmodifiableMap(new LinkedHashMap<String, Set<String>>(excludeStaticFieldMap));
        this.excludedThreads = unmodifiableSet(new LinkedHashSet<String>(excludedThreads));
    }

    public static final class Builder {
        private final Map<String, Set<String>> excludeFieldMap =
                new LinkedHashMap<String, Set<String>>();
        private final Map<String, Set<String>> excludeStaticFieldMap =
                new LinkedHashMap<String, Set<String>>();
