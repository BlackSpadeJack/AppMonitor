...
public abstract class AbstractAnalysisResultService extends IntentService {
    ...
    /**
     * Called after a heap dump is analyzed, whether or not a leak was found. Check
     * {@link AnalysisResult#leakFound} and {@link AnalysisResult#excludedLeak} to see if there was
     * a leak and if it can be ignored.
     * 
