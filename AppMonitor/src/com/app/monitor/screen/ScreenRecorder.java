package com.app.monitor.screen;
...
public class ScreenRecorder extends Thread {
    ...
    public void run() {
        try {
            ...
            mVirtualDisplay =
                    mMediaProjection.createVirtualDisplay(TAG + "-display", mWidth, mHeight, mDpi,
    ...
    private void prepareEncoder() throws IOException {
        try {
            ...
            // MediaFormat format = MediaFormat.createVideoFormat(MIME_TYPE, 720, 640);
