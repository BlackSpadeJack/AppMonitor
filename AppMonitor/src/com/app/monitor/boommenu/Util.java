...
public class Util {
    ...
    public void setCircleButtonStateListDrawable(
        ...
        WeakReference<Bitmap> imagePressed = new WeakReference<Bitmap>(Bitmap.createBitmap(
                2 * radius,
                2 * radius,
        ...
        WeakReference<Bitmap> imageNormal = new WeakReference<Bitmap>(Bitmap.createBitmap(
                2 * radius,
                2 * radius,
                Bitmap.Config.ARGB_8888));
