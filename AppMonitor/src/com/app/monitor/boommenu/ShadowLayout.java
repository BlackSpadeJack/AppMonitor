package com.app.monitor.boommenu;
...
public class ShadowLayout extends FrameLayout {
    ...
    private void setBackgroundCompat(int w, int h) {
        Bitmap bitmap =
                createShadowBitmap(w, h, mCornerRadius, mShadowRadius, mDx, mDy, ShadowColor,
                        Color.TRANSPARENT);
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            mCornerRadius =
                    attr.getDimension(R.styleable.ShadowLayout_sl_cornerRadius, getResources()
                            .getDimension(R.dimen.default_corner_radius));
            mShadowRadius =
                    attr.getDimension(R.styleable.ShadowLayout_sl_shadowRadius, getResources()
    ...
    private Bitmap createShadowBitmap(int shadowWidth, int shadowHeight, float cornerRadius,
        ...
        RectF shadowRect =
                new RectF(shadowRadius, shadowRadius, shadowWidth - shadowRadius, shadowHeight
                        - shadowRadius);
